				TITLE	Programa para contar los elementos pares de un arreglo usando procedimientos
...
Principal		PROC
				...
				; Obtener el total de pares de Arreglo1

				; Llamar al método ContarPares
				; Pasando los datos de Arreglo1
				; Poner en RCX la dirección de Arrreglo1
				; Poner en RDX el número de elementos de Arreglo1
				; Llamar al procedimiento
				; Guardar en la variable Pares el valor de retorno del procedimiento
				; Calcular el valor de la variable Impares por diferencia entre el total de elementos - Pares
